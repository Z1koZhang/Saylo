...
If MsgBox("The v3.1 realtime widget has been upgraded in place to v3.2. Start v3.2 now?", vbYesNo + vbQuestion, "Saylo v3.1 compatibility") <> vbYes Then WScript.Quit
